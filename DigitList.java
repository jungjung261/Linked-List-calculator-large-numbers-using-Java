public class DigitList {
    ...
    public static DigitList subDigitLists(int c, DigitList L1, DigitList L2) {
        ...
        if ((L1 == null) && (L2 == null))
            ...
            if (L1.getDigit() < c) {
                temp = new DigitList((10 + L1.getDigit()) - c, subDigitLists(1, L1.getNextDigit(), null));
            } else {
                temp = new DigitList(L1.getDigit() - c, subDigitLists(0, L1.getNextDigit(), null));
            }
        } else {
            if (L1.getDigit() < L2.getDigit()) {
                temp = new DigitList((10 + L1.getDigit()) - L2.getDigit() - c,
                        subDigitLists(1, L1.getNextDigit(), L2.getNextDigit()));
            } else if (L1.getDigit() == L2.getDigit() && c == 1) {
                temp = new DigitList(9, subDigitLists(1, L1.getNextDigit(), L2.getNextDigit()));
            } else {
                temp = new DigitList(L1.getDigit() - L2.getDigit() - c,
                        subDigitLists(0, L1.getNextDigit(), L2.getNextDigit()));
            }
        }
        return trimDigitList(temp);
    }
